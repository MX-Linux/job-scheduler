...
print_header() {
    echo -e "${BLUE}========================================${NC}"
    echo -e "${BLUE}  Job Scheduler Release Script${NC}"
    echo -e "${BLUE}========================================${NC}"
    echo
}
...
update_aur_package() {
    ...
    local tarball_url="https://github.com/MX-Linux/job-scheduler/archive/refs/tags/${version}.tar.gz"
    ...
    print_success "AUR package files updated"
